# Research Log: Unit 41 (u041) — Other State Recruiters & Statutory Boards — Uttar Pradesh
...
- **Timestamp**: 2026-09-12T21:11:00+05:30
...
Unit 41 covers major state statutory recruiting boards, public utility corporations, basic education examination regulatory bodies, and technical/agricultural university entrance systems in Uttar Pradesh:
...
- **Validation**: Passed `node scripts/data-sourcing/validate-details.mjs` with **0 errors** and **0 warnings** across all 182 repository dossiers.

| Exam ID | Title | Tier | Type | Entry Basic Pay | Benchmark Highlight | Validation |
| :--- | :--- | :---: | :---: | :---: | :--- | :---: |
| `upprpb-constable` | UP Police Civil Constable & PAC Recruitment | A | job | Level 3 (₹21,700) | 60,244 Vacancies / 48,17,441 Applicants / 76,184 Shortlisted (2024-26) | **PASS** |
| `upprpb-si` | UP Police Sub-Inspector & Platoon Commander | A | job | Level 6 (₹35,400) | 4,543 Vacancies / 15,75,760 Applicants / 12,333 Shortlisted (2025-26) | **PASS** |
| `uppcl-assistant-engineer` | UPPCL Assistant Engineer (Trainee) | A | job | Level 10 (₹56,100) | 240 Vacancies (2024-25 GATE route) / 113 Vacancies (2021) | **PASS** |
| `uppcl-junior-engineer` | UPPCL Junior Engineer (Trainee) | A | job | Level 7 (₹44,900) | 212 Vacancies / 1,42,380 Applicants (2021-22) | **PASS** |
| `uppcl-executive-assistant` | UPPCL Executive Assistant & Camp Assistant | A | job | Level 4 (₹27,200) | 1,273 Vacancies / 3,18,400 Applicants (2022-23) | **PASS** |
| `uptet` | UP Teacher Eligibility Test | B | job | Level 6 (₹35,400)* | 21,65,179 Applicants / 6,60,592 Qualified (2021) | **PASS** |
| `upcatet` | UP Combined Agriculture & Tech Entrance | B | entrance | Omitted | 3,200 Seats / 29,420 Applicants (2024) | **PASS** |
| `super-tet` | Super TET (UP Assistant Teacher ATRE) | B | job | Level 6 (₹35,400) | 69,000 Vacancies / 4,10,440 Appeared / 1,46,060 Qualified (2019) | **PASS** |
| `upprpb-radio-operator` | UP Police Radio Cadre | B | job | Level 4 (₹25,500) | 2,430 Vacancies / 5,39,841 Applicants (2022-24) | **PASS** |
| `upprpb-jail-warder` | UP Prison Jail Warder & Fireman | B | job | Level 3 (₹21,700) | 5,805 Vacancies / 6,83,190 Applicants (2018-21) | **PASS** |
| `upcet` | UP Combined Entrance Test | C | entrance | Omitted | 80,000 Seats / 1,60,000 Applicants (2021) | **PASS** |
